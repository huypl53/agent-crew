...
This project is indexed by GitNexus as **agent-crew** (1890 symbols, 3035 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/agent-crew/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/agent-crew/context` | Codebase overview, check index freshness |
| `gitnexus://repo/agent-crew/clusters` | All functional areas |
| `gitnexus://repo/agent-crew/processes` | All execution flows |
| `gitnexus://repo/agent-crew/process/{name}` | Step-by-step execution trace |
