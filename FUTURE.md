...
- [ ] dashboard enhance for water fall tracing tasks, session of agents
- [ ] in dashboard, I want to have the ability to see the details tasks, tasks of each agent.... I want much more intuitive visualization. These features are big, new branch for him
- [ ] clear the worker session when task done, send command `/clear`
